...
$active_group = 'groupone';
$active_record = TRUE;

$db['groupone']['hostname'] = 'localhost';
$db['groupone']['username'] = 'root';
$db['groupone']['password'] = '12345678'; //password database
$db['groupone']['database'] = 'Test'; //nama database pada sistem SCTP
$db['groupone']['dbdriver'] = 'mysql';
...
$db['grouptwo']['password'] = '12345678'; //password database
$db['grouptwo']['database'] = 'Test'; //nama database pada TOKI learning center
$db['grouptwo']['dbdriver'] = 'mysql';
